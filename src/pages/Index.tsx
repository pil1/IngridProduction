...
import { Loader2, Search, Zap, TrendingUp, Shield, FileText, Users } from "lucide-react";
    ...
    <div className="space-y-8 p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {features.map((feature, index) => {
          ...
          return (
            <Card key={index} className="hover:shadow-lg transition-shadow cursor-pointer group" onClick={() => navigate(feature.href)}>
