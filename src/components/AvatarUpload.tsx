...
import AvatarCropDialog from "./AvatarCropDialog"; // Import the new component
    ...
    <>
      <div className="flex flex-col items-center gap-4">
        ...
        >
          ...
          {!isLoading && preview && preview !== currentAvatarUrl && (
            <Button
              variant="ghost"
              size="icon"
        ...
        <p className="text-xs text-muted-foreground text-center">
          Drag & drop or click to upload image (max 2MB)
        </p>
      </div>
      <AvatarCropDialog
