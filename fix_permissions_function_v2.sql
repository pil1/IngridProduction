-- Fix the get_user_effective_permissions function with correct return types
...
BEGIN
    ...
    direct_permissions AS (
        SELECT
            perm.permission_key::CHARACTER VARYING,
            perm.permission_name::CHARACTER VARYING,
            perm.description,
            perm.category::CHARACTER VARYING,
            perm.module_id,
            up.is_granted,
            'direct'::CHARACTER VARYING as source,
            up.granted_by,
            up.granted_at,
            up.expires_at
    ...
    role_permissions_query AS (
        SELECT
            ...
            'role'::CHARACTER VARYING as source,
